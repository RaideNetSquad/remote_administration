...
#include <memory>
#include "../Client/ClientWindow/clientwindow.h"
...
QT_MOC_LITERAL(6, 71, 17) // "slot_DisplayError"

    },
    "ClientWindow\0newMessage\0\0on_pushButton_clicked\0"
    "slot_DisplayMessage\0str\0slot_DisplayError"
};
...
void ClientWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->slot_DisplayError((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ClientWindow::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientWindow::newMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ClientWindow::newMessage(const QString & _t1)
{
