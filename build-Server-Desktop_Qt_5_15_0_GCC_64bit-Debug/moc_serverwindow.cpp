...
#include <memory>
#include "../Server/ServerWindow/serverwindow.h"
...
QT_MOC_LITERAL(4, 47, 19), // "slot_DisplayMessage"
QT_MOC_LITERAL(5, 67, 7), // "message"
QT_MOC_LITERAL(6, 75, 16), // "slot_ErrorServer"
QT_MOC_LITERAL(7, 92, 9), // "textError"
QT_MOC_LITERAL(8, 102, 6), // "logger"
QT_MOC_LITERAL(9, 109, 13) // "newConnection"

    },
    "ServerWindow\0newMessage\0\0on_pushButton_clicked\0"
    "slot_DisplayMessage\0message\0"
    "slot_ErrorServer\0textError\0logger\0"
    "newConnection"
};
...
void ServerWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->slot_DisplayMessage((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 3: _t->slot_ErrorServer((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 4: _t->logger((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (ServerWindow::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ServerWindow::newMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ServerWindow::newMessage(const QString & _t1)
{
